...
const ReportContent: FC = (): ReactElement => {
  ...
  const params = Array.from({ length: 17 }, (_, i) => {
  ...
  return (
    <div style={{ height: "100vh", width: "100%" }}>
      <ViewerWrapper hiddenPrint={hiddenPrint} reportParam={parameter} reportUri="/assets/report/persediaan/stok_slow_moving.rdlx-json" />
    </div>
  );
};
